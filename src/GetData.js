...
const audioTests = [
  {
    title: 'alo',
    url: "http://api.soundcloud.com/tracks/109357301/stream?client_id=a7Ucuq0KY8Ksn8WzBG6wj4x6pcId6BpU",
  },
  {
...
class GetData extends Component {
  ...
  componentDidMount(){
    ...
    let track_id = '109357301';

    return fetch("https://api.soundcloud.com/tracks/" + track_id + "/streams" + "?client_id=" + client_id)
      .then((response) => response.json())
      .then((responseJson) => {
        console.log(responseJson);
        audioTests[0].url = responseJson.http_mp3_128_url;
        this.setState({
          data: responseJson,
